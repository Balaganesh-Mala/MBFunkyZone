...
const Cart = () => {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-10 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-sm border p-5 sm:p-6">
        {/* Header */}
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mt-2">
                  <button
                    ...
                    className="border rounded-full w-6 h-6 flex items-center justify-center text-xs bg-white"
                  >
                    −
                  </button>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center border-t pt-6 mt-6">
          ...
          <div className="flex gap-3 mt-4 sm:mt-0">
            {cartItems.length > 0 && (
              <button
                onClick={clearCart}
                className="bg-gray-100 border text-xs sm:text-sm px-4 py-2 rounded-full hover:border-black transition flex items-center gap-2"
              >
                <FaTrash /> Clear Cart
              </button>
            )}
